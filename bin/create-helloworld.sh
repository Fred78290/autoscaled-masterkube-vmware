...
export ETC_DIR=./config/${NODEGROUP_NAME}/deployment/helloworld
...
kubectl create secret tls $K8NAMESPACE -n $K8NAMESPACE --key ./etc/ssl/privkey.pem --cert ./etc/ssl/fullchain.pem --kubeconfig=./cluster/${NODEGROUP_NAME}/config
